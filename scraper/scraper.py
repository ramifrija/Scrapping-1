...
DATE_DEBUT = datetime.strptime("01/01/2025", "%d/%m/%Y")
DATE_FIN = datetime.strptime("28/02/2025", "%d/%m/%Y")
    ...
    try:
        ...
        for row in soup.select('tr.Tableau1'):
            ...
            try:
                ...
                # 🔽 Ne garder que les dates entre 01/01/2025 et 28/02/2025
                if not (DATE_DEBUT <= date_obj <= DATE_FIN):
                    continue
